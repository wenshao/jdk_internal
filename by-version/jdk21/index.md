...
| 特性 | 状态 | 说明 |
|------|------|------|
| **Virtual Threads** | 正式 | 虚拟线程，百万级并发 |
| **Pattern Matching for switch** | 正式 | switch 模式匹配 |
| **Record Patterns** | 预览 | 记录模式 |
| **String Templates** | 预览 | 字符串模板 |
| **Scoped Values** | 预览 | 作用域值 |
| **Structured Concurrency** | 预览 | 结构化并发 (孵化) |
| **分代 ZGC** | 正式 | 降低 GC 频率 |
| **分代 Shenandoah** | 正式 | 降低 GC 频率 |
