...
| 特性 | 影响 | 详情 |
|------|------|------|
| **局部变量类型推断（正式版）** | ⭐⭐⭐⭐⭐ | JEP 286，`var` 关键字 |
| **线程局部握手** | ⭐⭐⭐ | JEP 312 |
| **G1 并行 Full GC** | ⭐⭐⭐ | [JEP 307](/jeps/platform/jep-307.md) |
| **应用类数据共享** | ⭐⭐⭐ | [JEP 310](/jeps/performance/jep-310.md) |
| **基于 Java 的 JIT 编译器（实验）** | ⭐⭐⭐ | JEP 317，Graal JIT |
...
| JEP | 标题 | 说明 |
|-----|------|------|
| [JEP 286](/jeps/language/jep-286.md) | Local-Variable Type Inference | 局部变量类型推断 |
| [JEP 312](https://openjdk.org/jeps/312) | Thread-Local Handshakes | 线程局部握手 |
| [JEP 307](/jeps/platform/jep-307.md) | Parallel Full GC for G1 | G1 并行 Full GC |
| [JEP 310](/jeps/performance/jep-310.md) | Application Class-Data Sharing | 应用类数据共享 |
...
| [JEP 296](https://openjdk.org/jeps/296) | Consolidate the JDK Forest into a Single Repository | 合并 JDK 仓库 |
