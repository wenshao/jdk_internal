...
|------|------|------|
| **UTF-8 默认字符集** | ⭐⭐⭐⭐ | JEP 400 |
| **Simple Web Server** | ⭐⭐⭐ | [JEP 408](/jeps/tools/jep-408.md) |
...
| [JEP 408](/jeps/tools/jep-408.md) | Simple Web Server | 简单 Web 服务器 |
| [JEP 413](https://openjdk.org/jeps/413) | Code Snippets in Java API Documentation | 代码片段 |
| [JEP 416](/jeps/tools/jep-416.md) | Reimplement Core Reflection with Method Handles | 方法句柄重构反射 |
| [JEP 417](https://openjdk.org/jeps/417) | Vector API (Third Incubator) | Vector API（第3次孵化） |
| [JEP 418](https://openjdk.org/jeps/418) | Internet-Address Resolution SPI | 网络地址解析 SPI |
| [JEP 419](https://openjdk.org/jeps/419) | Foreign Function & Memory API (Second Incubator) | FFM API（第2次孵化） |
