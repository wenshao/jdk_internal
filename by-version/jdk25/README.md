...
| Compact Object Headers | 紧凑对象头 (位布局与内存节省) | [→](./deep-dive/compact-object-headers.md) |
| JFR Method Timing | JFR 方法级计时 | [→](./deep-dive/jfr-method-timing.md) |
| AOT 命令行优化 | AOT 缓存与方法分析 | [→](./deep-dive/aot-ergonomics.md) |
| Module Import Declarations | 模块导入声明 | [→](/deep-dive/jep-511-implementation.md) |
| 分代 ZGC | 分代 ZGC 设计与调优 | [→](./deep-dive/generational-zgc.md) |
| 分代 Shenandoah | 分代 Shenandoah GC 实现 | [→](./deep-dive/generational-shenandoah-implementation.md) |
| Structured Concurrency | 结构化并发实现 | [→](./deep-dive/structured-concurrency-implementation.md) |
| Stable Values | 稳定值实现 | [→](./deep-dive/stable-values-implementation.md) |
