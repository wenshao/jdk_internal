...
| [JEP 455](/jeps/jep-455.md) | Primitive Types in Patterns | 🔍 预览 | 原始类型模式匹配 | [→](/deep-dive/primitive-patterns.md) |
| [JEP 469](/jeps/jep-469.md) | Implicit Classes | 🔍 预览 | 隐式类 (第4次) | [→](/deep-dive/implicit-classes.md) |
| [JEP 466](/jeps/jep-466.md) | Class-File API | 🔍 预览 | 类文件 API | [→](/deep-dive/classfile-api.md) |
| [JEP 454](/jeps/jep-454.md) | Foreign Function & Memory API | ✅ 正式 | FFM API | [→](/deep-dive/foreign-function.md) |
| [JEP 444](/jeps/jep-444.md) | Virtual Threads | ✅ 正式 | 虚拟线程 | [→](/deep-dive/virtual-threads.md) |
...
| [JEP 462](/jeps/jep-462.md) | Structured Concurrency | 🔍 预览 | 结构化并发 (第5次) | [→](/deep-dive/structured-concurrency.md) |
| [JEP 448](/jeps/jep-448.md) | JVM Code Heap | 🚀 启动优化 | 代码堆分段 | [→](/deep-dive/code-heap.md) |
| [JEP 449](/jeps/jep-449.md) | Barrier-Based C2 | 🚀 吞吐量 | C2 编译器优化 | [→](/deep-dive/c2-barrier.md) |
...
|-----|------|------|------|----------|
| [JEP 462](/jeps/jep-462.md) | Structured Concurrency | 🔍 预览 | 结构化并发 (第5次) | [→](/deep-dive/structured-concurrency.md) |
| [JEP 467](/jeps/jep-467.md) | Scoped Values | 🔍 预览 | 作用域值 (第3次) | [→](/deep-dive/scoped-values.md) |

### 安全

| JEP | 标题 | 状态 | 描述 | 深度分析 |
|-----|------|------|------|----------|
| [JEP 451](/jeps/jep-451.md) | Prepare to Restrict Dynamic Loading | ⚠️ 废弃 | 动态加载限制 | [→](/deep-dive/dynamic-loading.md) |
| [JEP 452](/jeps/jep-452.md) | Key Encapsulation Mechanism API | ✅ 正式 | KEM API | [→](/deep-dive/kem-api.md) |
...
| **启动时间** | 代码堆优化 | ~5-10% | [→](/deep-dive/code-heap.md) |
| **吞吐量** | C2 barrier 优化 | ~3-5% | [→](/deep-dive/c2-barrier.md) |
...
| 高并发 I/O | 虚拟线程 | [→](/deep-dive/virtual-threads.md) |
| 并发任务 | 结构化并发 | [→](./deep-dive/structured-concurrency.md) |
...
| Structured Concurrency | 结构化并发实现 | [→](/deep-dive/structured-concurrency.md) |
| Virtual Threads | 虚拟线程实现 | [→](/deep-dive/virtual-threads.md) |
| Scoped Values | 作用域值实现 | [→](/deep-dive/scoped-values.md) |
