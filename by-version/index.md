...
| **JDK 25** | 2025-09-16 | Scoped Values (正式版)、Compact Object Headers |
...
JDK 8 ───────► JDK 11 ───────► JDK 17 ───────► JDK 21 ───────► JDK 25 ───────► JDK 26+
 │              │               │               │               │               │
 │              │               │               │               │               │
 ├─ 2017 EOL     ├─ 2026 EOL     ├─ 2029 EOL     ├─ 2031 EOL     ├─ Feature      └─ Feature
 └─ 付费延长    └─ 8年LTS       └─ 5年LTS       └─ 8年LTS
```
...
|----------|----------|------|
| JDK 26 | 保持 | 最新功能版本 |
| JDK 25 | 保持或 → JDK 26 | 体验新特性 |
| JDK 21 | → JDK 25 或 26 | 新特性，性能提升 |
| JDK 17 | → JDK 21 | LTS，虚拟线程 |
...
| JDK 24 | Feature 发布说明 | [→](jdk24/release-notes.md) |
| JDK 23 | Feature 发布说明 | [→](jdk23/release-notes.md) |
| JDK 22 | Feature 发布说明 | [→](jdk22/release-notes.md) |
| JDK 21 | LTS 发布说明 | [→](jdk21/release-notes.md) |
| JDK 20 | Feature 发布说明 | [→](jdk20/release-notes.md) |
| JDK 19 | Feature 发布说明 | [→](jdk19/release-notes.md) |
| JDK 18 | Feature 发布说明 | [→](jdk18/release-notes.md) |
| JDK 17 | LTS 发布说明 | [→](jdk17/release-notes.md) |
| JDK 16 | Feature 发布说明 | [→](jdk16/release-notes.md) |
| JDK 15 | Feature 发布说明 | [→](jdk15/release-notes.md) |
| JDK 14 | Feature 发布说明 | [→](jdk14/release-notes.md) |
| JDK 13 | Feature 发布说明 | [→](jdk13/release-notes.md) |
| JDK 12 | Feature 发布说明 | [→](jdk12/release-notes.md) |
| JDK 11 | LTS 发布说明 | [→](jdk11/release-notes.md) |
| JDK 10 | Feature 发布说明 | [→](jdk10/release-notes.md) |
| JDK 9 | Feature 发布说明 | [→](jdk9/release-notes.md) |
