...
| **Flexible Constructors（第2次预览）** | ⭐⭐⭐ | JEP 482 |
| **Implicit Classes（第3次预览）** | ⭐⭐⭐ | JEP 477 |
| **ZGC 默认分代模式** | ⭐⭐⭐⭐⭐ | JEP 474 |
| **Class-File API（第2次预览）** | ⭐⭐⭐⭐ | JEP 466 |
| **Stream Gatherers（第2次预览）** | ⭐⭐⭐⭐ | JEP 473 |
| **Structured Concurrency（第3次预览）** | ⭐⭐⭐⭐⭐ | JEP 480 |
| **Scoped Values（第3次预览）** | ⭐⭐⭐⭐ | JEP 481 |
| **Vector API（第8次孵化）** | ⭐⭐⭐ | JEP 469 |
...
| [JEP 469](https://openjdk.org/jeps/469) | Vector API (Eighth Incubator) | Vector API（第8次孵化） |
| [JEP 480](https://openjdk.org/jeps/480) | Structured Concurrency (Third Preview) | 结构化并发（第3次预览） |
| [JEP 481](https://openjdk.org/jeps/481) | Scoped Values (Third Preview) | 作用域值（第3次预览） |
| [JEP 471](https://openjdk.org/jeps/471) | Deprecate the Memory-Access Methods in sun.misc.Unsafe | 废弃 Unsafe 内存访问 |
| [JEP 472](https://openjdk.org/jeps/472) | Prepare to Restrict the Use of JNI | 准备限制 JNI 的使用 |
