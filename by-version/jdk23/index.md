...
JDK 23 引入了 Module Import Declarations（预览）、Markdown 文档注释和 Flexible Constructors。
...
| **Primitive Types in Patterns（预览）** | ⭐⭐⭐⭐ | JEP 455 |
| **Implicit Classes（第3次预览）** | ⭐⭐⭐ | JEP 469 |
| **Class-File API（第3次预览）** | ⭐⭐⭐⭐ | JEP 466 |
...
| [JEP 448](https://openjdk.org/jeps/448) | Flexible Constructors | 灵活构造器 |
| [JEP 455](https://openjdk.org/jeps/455) | Primitive Types in Patterns (Second Preview) | 原始类型模式匹配（第2次预览） |
| [JEP 469](https://openjdk.org/jeps/469) | Implicit Classes and Instance Main Methods (Third Preview) | 隐式类（第3次预览） |
...
| [JEP 475](https://openjdk.org/jeps/475) | Import Packages (Third Preview) | 导入包（第3次预览） |
