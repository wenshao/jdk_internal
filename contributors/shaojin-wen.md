...
| **角色** | JDK Committer |
| **Integrated PRs** | [97](https://github.com/openjdk/jdk/pulls?q=is%3Apr+author%3Awenshao+is%3Aclosed+label%3Aintegrated) |
...
| 合入类型 | 数量 | 占比 | 说明 |
|----------|------|------|------|
| 快速合入 (<24h) | 45 | 34% | 简单优化、清理类 PR |
| 正常合入 (1-7天) | 72 | 54% | 标准优化 PR |
| 延迟合入 (>7天) | 16 | 12% | 复杂或需讨论的 PR |
...
- [PR 深度分析: JDK-8355177](../prs/8355/8355177.md)
- [PR 深度分析: JDK-8370013](../prs/8370/8370013.md)
- [PR 深度分析: JDK-8366224](../prs/8366/8366224.md)
- [PR 深度分析: JDK-8349400](../prs/8349/8349400.md)
- [完整分析报告](shaojin-wen-analysis.md)