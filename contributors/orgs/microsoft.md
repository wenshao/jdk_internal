...
Microsoft 主要通过维护 Microsoft Build of OpenJDK 发行版参与生态，上游直接代码贡献较少，集中在 Windows 平台支持和 Azure 优化领域。
...
| 模块 | 文件数 | 说明 |
|------|--------|------|
| Azure 优化 | - | Azure 平台特定优化 |
| Build 系统 | - | Windows 构建系统支持 |
| Windows 支持 | - | Windows 平台兼容性 |
