...
| 指标 | 值 |
|------|-----|
| **主线 Integrated PRs** | 113+ |
| **Lilliput 项目 PRs** | **92** (rkennke, 占 Lilliput 仓库的 63%) |
| **JMC 项目 PRs** | **177** (thegreystone 165, 占 JMC 仓库的 55%) |
| **总计 PRs** | **382+** |
| **贡献者数** | 2 |
| **活跃时间** | 2020 - 至今 |
| **主要领域** | **Lilliput 项目主导**, **JMC 项目主导 (55%)**, JFR |
...
> Datadog 的 PR 被以下审查者审查最多 (共 487 次审查)
