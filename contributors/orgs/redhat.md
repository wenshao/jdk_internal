...
|------|--------|--------|-----|------|----------|------|
| 1 | Thomas Stuefe | [@tstuefe](https://github.com/tstuefe) | 347 | Reviewer | HotSpot Runtime, 内存, NMT | [详情](../../by-contributor/profiles/thomas-stuefe.md) |
| 2 | [Roland Westrelin](../../by-contributor/profiles/roland-westrelin.md) | [@rwestrel](https://github.com/rwestrel) | 225 | Reviewer | C2 编译器 | [详情](../../by-contributor/profiles/roland-westrelin.md) |
| 3 | Andrew Haley | [@theRealAph](https://github.com/theRealAph) | 71 | Reviewer | AArch64 | [详情](../../by-contributor/profiles/andrew-haley.md) |
| 4 | Andrew Hughes | — | 6 | Committer | 更新维护者/IcedTea | [详情](../../by-contributor/profiles/andrew-hughes.md) |

**小计**: 649+ PRs (当前团队)

> **重要更正**:
> - **Andrew Dinn** (@adinn, 25 PRs): GitHub bio 写明已转至 **IBM** OpenJDK Java Platform Team，移至前贡献者列表

### 前贡献者

| 贡献者 | GitHub | PRs | 现状 | 主要领域 | 档案 |
|--------|--------|-----|------|----------|------|
| Andrew Dinn | [@adinn](https://github.com/adinn) | 25 | **IBM** | AArch64, Byteman | [详情](../../by-contributor/profiles/andrew-dinn.md) |
| Severin Gehwolf | [@jerboaa](https://github.com/jerboaa) | 75 | **IBM** | 容器/cgroup/jlink | [详情](../../by-contributor/profiles/severin-gehwolf.md) |
| Roman Kennke | [@rkennke](https://github.com/rkennke) | 50+ | **Datadog** | Shenandoah GC | [详情](../../by-contributor/profiles/roman-kennke.md) |
| Aleksey Shipilev | [@shipilev](https://github.com/shipilev) | 803+ | **Amazon** | Shenandoah GC | [详情](../../by-contributor/profiles/aleksey-shipilev.md) |

> **注**:
> - Andrew Dinn (Red Hat Distinguished Engineer) 现已加入 IBM OpenJDK Java Platform Team
> - Severin Gehwolf 曾在 Red Hat 主导容器/cgroup 支持，现已加入 IBM
...
> **总计**: 1,200+ 贡献 (2010-2026, 其中 GitHub PR 始于 2020)
