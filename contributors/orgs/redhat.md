...
| 5 | Andrew Hughes | — | 6 | Committer | 更新维护者/IcedTea | [详情](../../by-contributor/profiles/andrew-hughes.md) |

**小计**: 668+ PRs (当前团队)

> **重要发现**:
> - **Roland Westrelin** (@rwestrel, 225 PRs) 是 Red Hat C2 编译器核心贡献者，之前完全遗漏
> - **Thomas Stuefe** 实际 PR 数为 347 (之前记录为 50+)
> - **Andrew Haley** 实际 PR 数为 71 (之前未记录)
