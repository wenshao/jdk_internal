...
> NMethod 重定位, AArch64 解释器, Amazon Corretto
...
| **主要领域** | NMethod 重定位 (JDK-8316694), AArch64 解释器优化 |

---

→ [完整 PR 列表 (18)](https://github.com/openjdk/jdk/pulls?q=is%3Apr+author%3Achadrako+is%3Aclosed+label%3Aintegrated)
