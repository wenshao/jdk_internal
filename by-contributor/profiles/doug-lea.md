...
| **职位** | Professor of Computer Science, Department Head |
| **GitHub** | [@DougLea](https://github.com/DougLea) |
| **OpenJDK** | [@dl](https://openjdk.org/census#dl) |
| **角色** | JDK Committer, JDK Reviewer, JSR-166 Spec Lead |
| **邮件** | dl@openjdk.org |
| **教育** | University of New Hampshire (BA 1976, MA 1978, PhD 1982, Computer Science) |
| **专长** | Java Concurrency, Memory Model, Fork/Join, Parallel Computing |
| **荣誉** | ACM Fellow (2013), Dahl-Nygaard Prize (2010), JavaOne Golden Duke Award (1998) |
...
| 学位 | 学校 | 年份 |
|------|------|------|
| BA | University of New Hampshire | 1976 |
| MA | University of New Hampshire | 1978 |
| PhD | University of New Hampshire | 1982 |

### 教育职位

- **Professor of Computer Science & Department Head**: SUNY Oswego
...
| 年份 | 奖项 | 颁发机构 |
|------|------|----------|
| **1998** | JavaOne Golden Duke Award | Sun Microsystems |
| **2010** | Dahl-Nygaard Prize (Senior) | AITO |
| **2013** | ACM Fellow | Association for Computing Machinery |

> ACM Fellow 当选理由: "for contributions to software, particularly in support of concurrency, including widely adopted libraries and frameworks that enable reliable multithreaded programming"
