...
Albert Mingkun Yang 是 Oracle 斯德哥尔摩团队的 GC 专家，2025 年 1 月 10 日获得乌普萨拉大学 (Uppsala University) 博士学位，博士论文题目为"温度感知垃圾回收器的设计与实现"。他是 JDK 26 周期最活跃的贡献者，有 **744 个 integrated PRs**，在 ZGC、G1 GC、Parallel GC 和 Serial GC 方面有深入研究。他的贡献特点是代码清理和重构，净删除超过 16,000 行代码。
...
| "Design and Implementation of Temperature-Aware Garbage Collectors" | 2025 | 博士论文 | 温度感知 GC |

### 博士论文

**学位**: PhD in Computing Science
**学校**: Uppsala University, Sweden
**年份**: 2025 (答辩日期: 2025-01-10)
**论文**: "Design and Implementation of Temperature-Aware Garbage Collectors"
**导师**: Tobias Wrigstad
**外部审查**: Richard Jones
**答辩链接**: [Uppsala University](https://www.uu.se/en/events/defences/2025-01-10-albert-mingkun-yang-design-and-implementation-of-temperature-aware-garbage-collectors)
