...
在 OpenJDK Census 中，他是 **Core Libraries Group 成员**、**Conformance Group 成员**、JDK Reviewer/Committer、JDK Updates Reviewer。他从 JDK 7 开始领导 XML 栈的升级工作 (JAXP 1.4, JAXB 2.2a, JAX-WS 2.2)，对 JDK XML 处理模块的演进有超过十五年的持续贡献。
...
| **OpenJDK** | [@joehw](https://openjdk.org/census#joehw) |
| **GitHub** | [JoeWang-Java](https://github.com/JoeWang-Java) |
| **角色** | JDK Reviewer/Committer, JDK Updates Reviewer, java.xml Module Lead |
| **OpenJDK Groups** | Core Libraries Group, Conformance Group |
