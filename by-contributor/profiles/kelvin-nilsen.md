...
| 年份 | 事件 | 详情 |
|------|------|------|
| **1995** | 实时 Java 研究开始 | 发表实时 Java 设计与实现论文 |
| **早期** | 加入 Amazon | JVM GC 团队，专注 Shenandoah |
...
Kelvin Nilsen 在实时 Java 和低延迟 GC 领域有超过 25 年的经验，是 Generational Shenandoah 的核心开发者之一。
...
| **公司** | [Amazon](https://www.amazon.com/) |
