...
> 容器与 cgroup 支持专家，jlink 运行时镜像链接改进核心贡献者，前 Red Hat OpenJDK 维护者 (现 IBM)
...
|------|-----|
| **姓名** | Severin Gehwolf |
| **当前组织** | [IBM](/contributors/orgs/ibm.md) (前 Red Hat) |
...
- **OpenJDK 维护**：曾作为 Red Hat 下游发行版维护者反馈上游改进，现在 IBM 继续贡献
