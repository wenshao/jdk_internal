...
#### [JDK-8355177: StringBuilder::append(char[]) 优化](../prs/8355/8355177.md)
...
#### [JDK-8370013: Double.toHexString 重构](../prs/8370/8370013.md)

**性能提升**: +20%

消除正则表达式和 StringBuilder 使用，直接使用位操作。

#### [JDK-8366224: DecimalDigits.appendPair](../prs/8366/8366224.md)
...
#### [JDK-8349400: 消除嵌套类](../prs/8349/8349400.md)
...
| Issue | 描述 | 提升 | 链接 |
|-------|------|------|------|
| 8355177 | StringBuilder::append(char[]) | +15% | [分析](../prs/8355/8355177.md) |
| 8370503 | Integer/Long toString | +10% | [JBS](https://bugs.openjdk.org/browse/JDK-8370503) |
| 8370013 | Double.toHexString | +20% | [分析](../prs/8370/8370013.md) |
| 8353741 | UUID.toString | +8% | [JBS](https://bugs.openjdk.org/browse/JDK-8353741) |
| 8366224 | DecimalDigits.appendPair | +12% | [分析](../prs/8366/8366224.md) |
...
| Issue | 描述 | 提升 | 链接 |
|-------|------|------|------|
| 8349400 | 消除嵌套类 | +5% | [分析](../prs/8349/8349400.md) |
...
- [GC 组件分析](../prs/components/gc.md)
- [编译器组件分析](../prs/components/compiler.md)
