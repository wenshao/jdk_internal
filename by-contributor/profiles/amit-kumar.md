...
> s390x 架构专家，IBM OpenJDK Team Lead
...
|------|-----|
| **姓名** | Amit Kumar |
| **当前组织** | IBM (Research Labs, ISDL) |
| **职位** | Development Team Lead, OpenJDK s390x Port Project Lead |
| **位置** | Bengaluru, India |
| **GitHub** | [@offamitkumar](https://github.com/offamitkumar) |
| **LinkedIn** | [amit-kumar-032644180](https://www.linkedin.com/in/amit-kumar-032644180/) |
| **OpenJDK** | [@amitkumar](https://openjdk.org/census#amitkumar) |
| **角色** | JDK Committer (2023-05), JDK Updates Committer (2024-11) |
| **主要领域** | s390x 架构，JIT 编译器，平台移植，性能优化 |
| **活跃时间** | 2018 - 至今 |

> **数据来源**: [LinkedIn](https://www.linkedin.com/in/amit-kumar-032644180/), [CFV Committer 2023-05](https://mail.openjdk.org/pipermail/jdk-dev/2023-May/007840.html), [CFV Updates 2024-11](https://mail.openjdk.org/pipermail/jdk-updates-dev/2024-November/006355.html)
...
| 属性 | 值 |
|------|-----|
| **学位** | B.Tech in Computer Science & Engineering |
| **院校** | Arya College of Engineering and IT, Jaipur, Rajasthan |
| **毕业时间** | 2018-2022 |
...
| 年份 | 事件 | 详情 |
|------|------|------|
| **2018-2022** | ACEIT Jaipur | B.Tech Computer Science |
| **~2017** | 加入 IBM | IBM Research Labs (ISDL) |
| **2018-2020** | OpenJDK s390 | 开始参与 s390x 移植 |
| **2023-05** | JDK Committer | 提名为 JDK Committer |
| **2024-11** | JDK Updates Committer | 提名为 JDK Updates Project Committer |
| **至今** | Team Lead | OpenJDK s390x Port Project Lead |
