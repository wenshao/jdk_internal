...
> **Class File API 实现负责人** | Principal Java Engineer, Oracle
...
| 时间 | 事件 | 详情 |
|------|------|------|
| **2019** | Freelancer | Big Semantic Data Architect and Engineer |
| **2020-01** | 加入 Oracle | Principal Java Engineer |
...
| 审查者 | 领域 | 组织 |
|--------|------|------|
| [Chen Liang](/by-contributor/profiles/chen-liang.md) | ClassFile API, javac | Oracle |
| [Jonathan Gibbons](/by-contributor/profiles/jonathan-gibbons.md) | javac, 语言规范 | Oracle |
| [Claes Redestad](/by-contributor/profiles/claes-redestad.md) | 核心库, 性能 | Oracle |
| [Brian Goetz](/by-contributor/profiles/brian-goetz.md) | 语言架构, JEP 指导 | Oracle |
...
- [Chen Liang (协作者)](/by-contributor/profiles/chen-liang.md)
- [Claes Redestad (性能优化指导)](/by-contributor/profiles/claes-redestad.md)
