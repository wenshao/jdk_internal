...
1. [什么是 JSR？](#1-什么是-jsr)
2. [JSR vs JEP 对比](#2-jsr-vs-jep-对比)
3. [主题分类](#3-主题分类)
4. [JSR 生命周期](#4-jsr-生命周期)
5. [知名 JSR 贡献者](#5-知名-jsr-贡献者)
6. [源码参考](#6-源码参考)
7. [重要 JSR 详解](#7-重要-jsr-详解)
8. [JSR 与 JEP 的协同](#8-jsr-与-jep-的协同)
9. [相关链接](#9-相关链接)
10. [参考](#10-参考)
...
| JSR | 标题 | 版本 | 状态 | 说明 |
|-----|------|------|------|------|
| [JSR 400](platform/jsr-400.md) ⭐ | Java SE 25 Platform | 25 | ✅ Final | 最新 LTS 平台规范 |
