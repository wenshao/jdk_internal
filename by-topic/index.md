...
1. [分类导航](#1-分类导航)
2. [OpenJDK 重大项目](#2-openjdk-重大项目)
3. [学习路径](#3-学习路径)
4. [场景索引](#4-场景索引)
5. [特性首发版本速查](#5-特性首发版本速查)
6. [版本选择指南](#6-版本选择指南)
7. [按领域选择 JDK 版本](#7-按领域选择-jdk-版本)
8. [性能提升汇总](#8-性能提升汇总)
9. [相关链接](#9-相关链接)
...
| Primitive Types in Patterns | JDK 23 | 2+ | JDK 26 | JEP 455, JEP 488 |
...
| Generational Shenandoah | JDK 25 | 生产 | JEP 521 |
