...
1. [时间线概览](#1-时间线概览)
2. [JDBC 架构](#2-jdbc-架构)
3. [JDK 1.1 - JDBC 1.x](#3-jdk-11---jdbc-1x)
4. [JDK 4 - JDBC 3.0](#4-jdk-4---jdbc-30)
5. [JDK 5 - JDBC 4.0](#5-jdk-5---jdbc-40)
6. [JDK 7 - JDBC 4.1](#6-jdk-7---jdbc-41)
7. [JDK 8 - JDBC 4.2](#7-jdk-8---jdbc-42)
8. [JDK 11 - JDBC 4.3](#8-jdk-11---jdbc-43)
9. [JDK 26 - JDBC 4.4](#9-jdk-26---jdbc-44)
10. [连接池](#10-连接池)
11. [JDBC 最佳实践](#11-jdbc-最佳实践)
12. [时间线总结](#12-时间线总结)
13. [相关链接](#13-相关链接)
