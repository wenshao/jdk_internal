...
1. [时间线概览](#1-时间线概览)
2. [日志体系结构](#2-日志体系结构)
3. [JDK 1.0 - System.out](#3-jdk-10---systemout)
4. [JDK 1.4 - JUL (java.util.logging)](#4-jdk-14---jul-javautillogging)
5. [SLF4J - 日志门面](#5-slf4j---日志门面)
6. [Logback - 推荐实现](#6-logback---推荐实现)
7. [Log4j 2 - 流行实现](#7-log4j-2---流行实现)
8. [JDK 9+ - Console 格式化](#8-jdk-9---console-格式化)
9. [日志级别](#9-日志级别)
10. [最佳实践](#10-最佳实践)
11. [日志桥接](#11-日志桥接)
12. [时间线总结](#12-时间线总结)
...
## 4. JDK 1.4 - JUL (java.util.logging)
