...
| **JDK 14** | Records (预览) | JEP 359 | 不可变类 |
...
| **JDK 25** | 模块导入 | JEP 511 | import module |
| **JDK 25** | 紧凑源文件 | JEP 512 | 简化入门 |
...
**JDK 14 预览, JDK 14 预览, JDK 14 正式 (JEP 361)**
...
**JDK 21 预览, JDK 18 第二次预览, JDK 19 第三次预览, JDK 21 正式 (JEP 441)**
