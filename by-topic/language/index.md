...
> **String Templates 注**: 该特性经 JEP 430 (JDK 22) 和 JEP 459 (JDK 22) 两轮预览后，因处理器设计
...
| switch 表达式 | JDK 14 (JEP 325) | JDK 14 | JEP 361 |
| Text Blocks | JDK 15 (JEP 355) | JDK 15 | JEP 378 |
| Records | JDK 16 (JEP 359) | JDK 16 | JEP 395 |
| instanceof 模式 | JDK 16 (JEP 305) | JDK 16 | JEP 394 |
| Sealed Classes | JDK 17 (JEP 360) | JDK 17 | JEP 409 |
| switch 模式匹配 | JDK 21 (JEP 406) | JDK 21 | JEP 441 |
| Record Patterns | JDK 21 (JEP 405) | JDK 21 | JEP 440 |
| 未命名变量与模式 | JDK 22 (JEP 443) | JDK 22 | JEP 456 |
| 紧凑源文件 | JDK 22 (JEP 463) | JDK 25 | JEP 512 |
| 模块导入声明 | JDK 25 (JEP 476) | JDK 25 | JEP 511 |
| 灵活构造体 | JDK 25 (JEP 447) | JDK 25 | JEP 513 |
| 原始类型模式 | JDK 26 (JEP 455) | 预览中 | JEP 530 (JDK 26 第四预览) |
...
| 紧凑源文件 | JDK 22 | JDK 25 | JEP 463 -> ... -> 512 |
