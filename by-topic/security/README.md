...
| 版本 | 主题 | 关键特性 | 说明 |
|------|------|----------|------|
| **JDK 15** | DTLS 1.2 | DTLS 1.2 支持 (JEP 373) | UDP 上的安全传输 |
...
| **JDK 25** | 后量子应用 | ML-DSA JAR 签名 (JEP 518)、HPKE 混合加密、PEM v2 (JEP 524)、HTTP/3 预览 (JEP 517) | 后量子签名进入实际应用场景 |
...
| JEP 370 | SHA-3 Hash Functions | JDK 14 | 已发布 | SHA3-256/384/512、SHAKE128/256 |
...
| JEP 373 | DTLS 1.2 | JDK 15 | 已发布 | UDP 上的安全传输层 |
| JEP 517 | HTTP/3 for the HTTP Client API (Preview) | JDK 25 | 预览 | 基于 QUIC 的 HTTP/3 支持 |
...
| JDK 25 | **ML-DSA JAR 签名**、**HPKE 混合公钥加密**、PEM v2、**HTTP/3** (预览) | JEP 518, JEP 524, JEP 517 |
...
| Security Manager 状态 | 已永久禁用 | JEP 411 (JDK 24) → JEP 486 (JDK 24) |
