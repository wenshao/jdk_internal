...
> **30 秒速读**
> - TLS 1.3 (JDK 11, JEP 332): 现代传输层安全协议，性能显著提升
> - 后量子密码 (JDK 24): ML-KEM 密钥封装 (JEP 496, FIPS 203) + ML-DSA 数字签名 (JEP 497, FIPS 204)
> - Security Manager 已永久禁用 (JDK 24, JEP 486)，JDK 17 标记弃用 (JEP 411)
> - KDF API (JDK 25, JEP 510): 密钥派生函数 HKDF 正式发布
> - JDK 26 新增: HPKE 混合公钥加密 (RFC 9180)、ML-DSA JAR 签名、PEM API 二次预览
> - 架构: JCA/JCE 提供者框架，支持 SunJCE/SunPKCS11 等多提供者
...
### ML-DSA JAR 签名 (JDK-8332893, JDK 26)
...
| **代码审计 + 依赖扫描** | 供应链安全 | 结合 ML-DSA JAR 签名 (JDK-8332893) 验证依赖完整性 |
...
| JAR 签名 | SHA256withRSA | ML-DSA (JDK-8332893) |
...
- [JDK-8332893: ML-DSA JAR Signatures](https://bugs.openjdk.org/browse/JDK-8332893)
...
| 版本 | 安全关键变化 |
|------|-------------|
| [JDK 8](/by-version/jdk8/) | Base64 API、ALPN 支持 |
| [JDK 9](/by-version/jdk9/) | DTLS 1.0/1.2、SHA-3 |
| [JDK 11](/by-version/jdk11/) | TLS 1.3 (JEP 332)、ChaCha20 (JEP 329) |
| [JDK 15](/by-version/jdk15/) | EdDSA 签名 (JEP 339) |
| [JDK 17](/by-version/jdk17/) | Security Manager 废弃 (JEP 411) |
| [JDK 25](/by-version/jdk25/) | KDF API (JEP 510)、PEM 编码 (JEP 470) |

## 推荐阅读

- [密码学主题](../../crypto/) — 加密算法、密钥管理、后量子密码学
- [国际化主题](../i18n/) — 安全相关的 locale 与编码处理
- [JEP 486: 永久禁用 Security Manager](/jeps/security/jep-486.md) — Security Manager 移除的完整分析
