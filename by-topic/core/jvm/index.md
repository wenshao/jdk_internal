...
- **JDK 26**: 默认启用 (`-XX:+UseCompactObjectHeaders`)，参见 JEP 519
...
**JDK 优化历史**:
- JDK 10: Loop strip mining (JEP 332 相关) — 将大循环拆分为带 safepoint poll 的外层循环
- JDK 17+: Thread-local handshake — 允许对单个线程执行操作，无需全局 STW
