...
```
2012 ───── 2017 ───── 2019 ───── 2022 ───── 2024 ───── 2025
 │            │            │            │            │            │
Graal        GraalVM     GraalVM     GraalVM     GraalVM     GraalVM
项目         首发        社区版       JDK 17      JDK 21      JDK 24
             1.0        19.0        基线        基线        基线
```
...
| 特性 | 说明 | 适用场景 |
|------|------|----------|
| **Graal JIT** | Java 编写的 JIT 编译器 | 替代 C2，更好优化 |
| **Native Image** | AOT 编译为原生可执行文件 | 快启动、低内存 |
| **Truffle** | 多语言运行时框架 | 实现 JVM 语言 |
| **Polyglot** | 多语言互操作 | 跨语言调用 |

### 性能对比

| 指标 | HotSpot | Graal JIT | Native Image |
|------|---------|-----------|--------------|
| 启动时间 | 基准 | +10-20% | **-90%** |
| 峰值性能 | 基准 | ±10% | -10~30% |
| 内存占用 | 基准 | +20-30% | **-50%** |
