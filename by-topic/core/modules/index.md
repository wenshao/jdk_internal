...
```
JDK 1.0 ── JDK 8 ── JDK 9 ── JDK 11 ── JDK 16 ── JDK 17 ── JDK 21 ── JDK 23
   │         │        │        │        │        │        │        │
单一下载  RT.jar   JPMS    jlink   jpackage  强封装  模块     模块
          Monolith  JEP    JEP    JEP     JDK     导出     导出
          Jar      200/261 282   343     内部    增强     增强
                   module-info      JDK    API     隐式
                   .java            16     封装     声明
```
...
| **JDK 11** | 模块化增强 | 稳定化 | - |
| **JDK 16** | jpackage | 原生打包 | JEP 343, 392, 384, 394 |
| **JDK 17** | 强封装 | JDK 内部 API 封装 | JEP 403, 396, 407, 411 |
| **JDK 21** | 模块导出增强 | 隐式声明 | - |
| **JDK 23** | 模块导入声明 | 简化导入 | JEP 467 |
