...
│  └── Shenandoah 共同维护 (Aleksey Shipilev, Zhengyu Gu)        │
│                                                                 │
│  Red Hat (15%+)                                                 │
│  ├── Shenandoah 创始团队 (William Kemper, Roman Kennke)        │
...
| 公司 | 贡献者 | PRs | 主要 JEP | 核心文件 |
|------|--------|-----|----------|----------|
| **Oracle** | [Aleksey Shipilev](/by-contributor/profiles/aleksey-shipilev.md) | 324+ | JEP 379 | `shenandoahHeap.cpp` |
...
├── JEP 333: ZGC (Incubator)
├── JEP 368: ZGC (Production)
├── JEP 377: ZGC on Windows
├── 198+ integrated PRs
└── ZGC 染色指针技术创始人
...
| **JEP 379** | Shenandoah GC (Standard) | Aleksey Shipilev | Oracle (ex-Red Hat) | JDK 15 |
| **JEP 333** | ZGC (Incubator) | Per Lidén | Oracle | JDK 11 |
...
│                                                                 │
│  Aleksey Shipilev                                               │
│  Red Hat (2016-2023) ──→ Oracle (2023-至今)                    │
│  ├── Red Hat 时期：Shenandoah GC 创始人                        │
│  └── Oracle 时期：继续 Shenandoah 维护，主导 JEP 503           │
│                                                                 │
│  William Kemper                                                 │
...
│  ├── 研发基地：捷克 (Roman Kennke), 德国 (Aleksey Shipilev)    │
...
|------|-------|-----|------------|
| **首次引入** | JDK 6 (2011) | JDK 11 (2018) | JDK 12 (2019) |
| **成为默认** | JDK 9 (2017) | - | - |
| **生产就绪** | JDK 9 (2017) | JDK 15 (2020) | JDK 15 (2020) |
| **分代支持** | 原生支持 | JDK 21 (2023) | JDK 25 (2024) |
| **成熟周期** | 12 年 | 8 年 | 7 年 |
...
| **2017** | JDK 9 成为默认 GC | JDK 11 实验性发布 | 设计启动 (Red Hat) |
| **2018** | JDK 11 持续优化 | - | JDK 12 实验性发布 |
| **2019** | JDK 12 可中断 Mixed GC | JDK 14 生产可用 | JDK 15 生产就绪 |
...
2014: Aleksey 加入 Red Hat，启动 Shenandoah 项目
2017: Shenandoah 集成到 OpenJDK 12
2019: Aleksey 离开 Red Hat 加入 Oracle
