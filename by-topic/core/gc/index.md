...
| **JDK 24+** | G1 / ZGC | 非分代 ZGC 已移除 (JEP 490)，分代 Shenandoah 实验性 (JEP 404) |
| **JDK 25+** | G1 / ZGC / Shenandoah | 分代 Shenandoah 生产就绪 (JEP 521) |
...
| JDK 24 | 分代 Shenandoah 引入 | JEP 404 | 实验性 (需 `-XX:+UnlockExperimentalVMOptions`) |
| JDK 25 | 分代 Shenandoah 生产就绪 | JEP 521 | 正式版 (不再需要实验性标志) |
...
JEP 521 将分代 Shenandoah 从实验性特性 (JEP 404, JDK 24) 提升为生产就绪的产品特性。经过 DaCapo、SPECjbb2015 等基准测试及多平台实际部署验证。
...
JEP 519 将紧凑对象头从实验性特性 (JEP 450, JDK 24) 提升为产品特性。已在 Oracle 全套 JDK 测试和 Amazon 数百个生产服务中验证。
