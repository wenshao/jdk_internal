...
1. [结论先行](#1-结论先行)
2. [一眼看懂](#2-一眼看懂)
3. [1. 方法内联友好设计](#3-1-方法内联友好设计)
4. [2. 循环优化友好设计](#4-2-循环优化友好设计)
5. [3. 避免对象逃逸](#5-3-避免对象逃逸)
6. [4. 类型稳定与去虚拟化](#6-4-类型稳定与去虚拟化)
7. [5. 常量折叠友好](#7-5-常量折叠友好)
8. [6. 避免 Deoptimization](#8-6-避免-deoptimization)
9. [7. 反射优化](#9-7-反射优化)
10. [8. 异常处理优化](#10-8-异常处理优化)
11. [9. 数组与集合优化](#11-9-数组与集合优化)
12. [10. 并行流优化](#12-10-并行流优化)
13. [实战案例](#13-实战案例)
14. [诊断工具](#14-诊断工具)
15. [常见陷阱](#15-常见陷阱)
16. [总结](#16-总结)
