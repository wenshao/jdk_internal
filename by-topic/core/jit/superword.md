...
1. [一眼看懂](#1-一眼看懂)
2. [SIMD 概述](#2-simd-概述)
3. [SuperWord 架构](#3-superword-架构)
4. [向量化条件](#4-向量化条件)
5. [成本模型 (JDK-8340093)](#5-成本模型-jdk-8340093)
6. [SuperWord 优化类型](#6-superword-优化类型)
7. [VTransform 架构 (JDK 26+)](#7-vtransform-架构-jdk-26)
8. [JVM 参数](#8-jvm-参数)
9. [性能影响](#9-性能影响)
10. [编程建议](#10-编程建议)
11. [近期改进](#11-近期改进)
