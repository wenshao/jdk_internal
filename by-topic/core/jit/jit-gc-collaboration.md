...
1. [结论先行](#1-结论先行)
2. [一眼看懂](#2-一眼看懂)
3. [1. 逃逸分析与 GC](#3-1-逃逸分析与-gc)
4. [2. 标量替换](#4-2-标量替换)
5. [3. Safepoint 插入](#5-3-safepoint-插入)
6. [4. Barrier 优化](#6-4-barrier-优化)
7. [5. 对象分配优化](#7-5-对象分配优化)
8. [6. 去优化与 GC](#8-6-去优化与-gc)
9. [7. 代码缓存与 GC](#9-7-代码缓存与-gc)
10. [8. 编译排队与 GC](#10-8-编译排队与-gc)
11. [9. 实战优化](#11-9-实战优化)
12. [10. 诊断与监控](#12-10-诊断与监控)
13. [总结](#13-总结)
14. [相关链接](#14-相关链接)
