...
5. [循环剥离 (Loop Peeling)](#5-循环剥离-loop-peeling)
6. [循环外提 (Loop Hoisting)](#6-循环外提-loop-hoisting)
7. [循环不变代码外提](#7-循环不变代码外提)
8. [其他循环优化](#8-其他循环优化)
9. [C2 PhaseIdealLoop](#9-c2-phaseidealloop)
10. [性能影响](#10-性能影响)
11. [诊断和调试](#11-诊断和调试)
12. [编程建议](#12-编程建议)
13. [相关链接](#13-相关链接)
