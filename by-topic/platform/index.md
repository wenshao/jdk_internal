...
| 主题 | 说明 |
|------|------|
| [容器支持](linux/index.md) | Docker/Kubernetes 资源感知 |
| [cgroup 支持](linux/index.md) | cgroup v1/v2 内存和 CPU 检测 |
| [性能调优](linux/index.md) | Linux 特定性能优化 |
| [系统调用](linux/index.md) | Linux 系统调用优化 |
...
| 主题 | 说明 |
|------|------|
| [Apple Silicon](macos/index.md) | M1/M2/M3/M4 原生支持 |
| [Metal 渲染](macos/index.md) | Metal 渲染管道 |
| [公证要求](macos/index.md) | macOS 应用签名 |
| [性能调优](macos/index.md) | macOS 特定优化 |
...
| 主题 | 说明 |
|------|------|
| [安装与部署](windows/index.md) | MSI/EXE 安装程序 |
| [服务集成](windows/index.md) | Windows 服务支持 |
| [注册表集成](windows/index.md) | Java Preferences API |
| [性能调优](windows/index.md) | Windows 特定优化 |
...
| 主题 | 说明 |
|------|------|
| [资源感知](containers/index.md) | CPU/内存限制检测 |
| [Docker 优化](containers/index.md) | Docker 最佳实践 |
| [Kubernetes](containers/index.md) | K8s 部署优化 |
| [镜像优化](containers/index.md) | 容器镜像最佳实践 |
