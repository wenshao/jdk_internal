...
| 主题 | 说明 |
|------|------|
| [容器支持](linux/README.md) | Docker/Kubernetes 资源感知 |
| [cgroup 支持](linux/README.md) | cgroup v1/v2 内存和 CPU 检测 |
| [性能调优](linux/README.md) | Linux 特定性能优化 |
| [系统调用](linux/README.md) | Linux 系统调用优化 |
...
| 主题 | 说明 |
|------|------|
| [Apple Silicon](macos/README.md) | M1/M2/M3/M4 原生支持 |
| [Metal 渲染](macos/README.md) | Metal 渲染管道 |
| [公证要求](macos/README.md) | macOS 应用签名 |
| [性能调优](macos/README.md) | macOS 特定优化 |
...
| 主题 | 说明 |
|------|------|
| [安装与部署](windows/README.md) | MSI/EXE 安装程序 |
| [服务集成](windows/README.md) | Windows 服务支持 |
| [注册表集成](windows/README.md) | Java Preferences API |
| [性能调优](windows/README.md) | Windows 特定优化 |
...
| 主题 | 说明 |
|------|------|
| [资源感知](containers/README.md) | CPU/内存限制检测 |
| [Docker 优化](containers/README.md) | Docker 最佳实践 |
| [Kubernetes](containers/README.md) | K8s 部署优化 |
| [镜像优化](containers/README.md) | 容器镜像最佳实践 |
