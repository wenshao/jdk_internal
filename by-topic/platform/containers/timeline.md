...
2. [JDK 10: 容器感知 (JDK-8146115)](#2-jdk-10-容器感知-jdk-8146115)
...
7. [JDK 25: 容器密度提升 (LTS)](#7-jdk-25-容器密度提升-lts)
8. [JDK 26: 容器优化增强](#8-jdk-26-容器优化增强)
9. [容器技术时间线](#9-容器技术时间线)
10. [JVM 参数演进](#10-jvm-参数演进)
11. [基础镜像演进](#11-基础镜像演进)
12. [核心贡献者](#12-核心贡献者)
13. [参考资料](#13-参考资料)
...
2016 ─── Linux 内核 4.5: cgroup v2 合并
   │
2018 ─── RHEL 8: 默认使用 cgroup v1 (RHEL 9 起默认 v2)
   │
...
| 日期 | 版本 | 变化 |
|------|------|------|
| 2025-09 | JDK 25 | 容器密度提升 (LTS) |

**核心特性**:
- Compact Object Headers (JEP 519) -- 对象头 12 字节缩减到 8 字节，堆使用减少约 22%
- 更高容器部署密度，相同内存限制下可运行更多实例
- AOT 命令行增强 (JEP 514)
...
2016 ─── cgroup v2 合并 (Linux 4.5)
   │
2018 ─── RHEL 8 默认 cgroup v1 (RHEL 9 起默认 v2)
   │
2021 ─── Ubuntu 21.04 默认 cgroup v2
```
