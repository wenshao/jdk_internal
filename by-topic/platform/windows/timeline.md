...
| JDK 14 | 2020-09 | jpackage 第二孵化器 (JEP 343) |
...
| 版本 | 日期 | 状态 |
|------|------|------|
| JDK 21 | 2023-09 | 废弃 x86 (32位) (JEP 449) |
| JDK 24 | 2025-03 | 移除 x86 (32位) (JEP 479) |
...
JDK 5  ─── x64 (64位)
   │
JDK 21 ─── 废弃 x86 (32位) (JEP 449)
   │
JDK 24 ─── 移除 x86 (32位) (JEP 479)
   │        └── x64 (64位) 唯一支持
```
...
| 贡献者 | 组织 | 主要贡献 |
|--------|------|----------|
| Andrew Leonard | Oracle | Windows 构建 |
