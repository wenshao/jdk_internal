...
### Issue
 * [JDK-8356047](https://bugs.openjdk.org/browse/JDK-8356047): [macos] jpackage produces confusing post- and pre- installation PKG scripts (**Bug** - P4)
...
`$ git fetch https://git.openjdk.org/jdk.git pull/25510/head:pull/25510` \
`$ git checkout pull/25510`

Update a local copy of the PR: \
`$ git checkout pull/25510` \
`$ git pull https://git.openjdk.org/jdk.git pull/25510/head`

</details>
<details><summary>Using Skara CLI tools</summary>

Checkout this PR locally: \
`$ git pr checkout 25510`
...
<a href="https://git.openjdk.org/jdk/pull/25510.diff">htt
