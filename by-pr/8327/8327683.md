...
### Issue
 * [JDK-8327683](https://bugs.openjdk.org/browse/JDK-8327683): Crash with primitive type pattern and generic expression in instanceof (**Bug** - P4)
...
`$ git fetch https://git.openjdk.org/jdk.git pull/18168/head:pull/18168` \
`$ git checkout pull/18168`

Update a local copy of the PR: \
`$ git checkout pull/18168` \
`$ git pull https://git.openjdk.org/jdk.git pull/18168/head`
