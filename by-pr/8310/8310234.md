...
### Issue
 * [JDK-8310234](https://bugs.openjdk.org/browse/JDK-8310234): Refactor Locale tests to use JUnit (**Sub-task** - P4)
...
`$ git fetch https://git.openjdk.org/jdk.git pull/14609/head:pull/14609` \
`$ git checkout pull/14609`

Update a local copy of the PR: \
`$ git checkout pull/14609` \
`$ git pull https://git.openjdk.org/jdk.git pull/14609/head`

</details>
<details><summary>Using Skara CLI tools</summary>

Checkout this PR locally: \
`$ git pr checkout 14609`
