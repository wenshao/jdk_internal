...
> **最后更新**: 2026-06-06 | **数据状态**: 实时更新 | [刷新数据](#)

> **最新动态**: PR 数据更新至 2026-06-06（+1,030 PRs，主仓库 +647 含 583 个 JDK 27 PR），JDK 27 补全 9 个 JEP，6 个子仓库数据刷新
...
| 指标 | 值 | 趋势 | 状态 |
|------|-----|------|------|
| **总 Integrated PRs** | 46,162 | 📈 +1,030 | ✅ 健康 |
| **覆盖仓库** | 25 个 | — | ✅ 良好 |
| **唯一贡献者** | 797 人 (主仓库) | 📈 | ✅ 良好 |
...
### 2026-06-06
- ✅ PR 数据更新至 2026-06-06（主仓库 27,054 PRs，+647；全仓库 46,162，+1,030）
- ✅ 6 个子仓库刷新（jdk25u-dev +109, jdk17u-dev +121, jdk21u-dev +96, jdk11u-dev +28, jdk8u-dev +1, jdk24u +0）
- ✅ JBS 元数据 + 审查者富化补全（642 JBS / 647 reviewers，0 失败）
- ✅ JDK 27 文档补全 9 个 JEP（GA 2026-09-15，Rampdown Phase One），contributions 1,689→2,312
- ✅ Chen Liang 档案刷新（237→244 PRs）
- ✅ 新增 `scripts/enrich-subrepo-csvs.py` 子仓库富化工具
- ✅ 重新生成 5 个核心 stats 报告 + 12 个版本贡献统计
