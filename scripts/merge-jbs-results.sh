#!/bin/bash
# Merge JBS results from 4 machines into the main cache
...
scp root@172.16.0.199:/tmp/jbs_result4.json /tmp/ 2>/dev/null && echo "  Got result4 from 172.16.0.199" || echo "  FAILED: 172.16.0.199"
...
PARTS = ['/tmp/jbs_result1.json', '/tmp/jbs_result2.json', '/tmp/jbs_result3.json', '/tmp/jbs_result4.json']
